              ...
              <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <input {...register('arabic_title')} dir="rtl" placeholder="سورة يس"
                    className="w-full px-4 py-2 bg-gray-50 dark:bg-[#252731] border border-gray-200 dark:border-gray-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 text-right font-arabic" />
                </div>
