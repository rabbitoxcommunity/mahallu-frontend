        ...
        <div className="min-h-screen flex bg-gray-50">
                        ...
                        <div>
                            <div className="relative">
                                ...
                                <input
                                    type="email"
                                    placeholder="Email"
                                    className={`w-full pl-11 text-sm pr-4 py-3 bg-white border ${errors.email ? 'border-red-500' : 'border-gray-200'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0B65F6] focus:border-transparent transition-colors text-gray-900`}
                                    {...register("email", {
                        ...
                        <div>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-11 text-sm pr-12 py-3 bg-white border ${errors.password ? 'border-red-500' : 'border-gray-200'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0B65F6] focus:border-transparent transition-colors text-gray-900`}
                                    {...register("password", {
            ...
            <div className="hidden lg:flex w-1/2 bg-[#0B65F6] flex-col items-center justify-center p-12 relative overflow-hidden">
                ...
                <div className="relative z-10 text-center mt-12 text-white max-w-sm">
                    ...
                    <p className="text-blue-100 text-sm">Everything you need in an easily customizable dashboard.</p>
