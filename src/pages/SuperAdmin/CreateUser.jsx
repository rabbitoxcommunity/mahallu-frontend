          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/60 rounded-xl p-6">
              ...
              <div className="space-y-2">
                {Object.entries(createdUser.user.permissions).map(([key, enabled]) => {
    ...
    <div className="w-full">
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">
          Add a new user to your tenant with specific permissions
        </p>
      </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className={`w-full pl-10 pr-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0B65F6] dark:bg-[#252731] dark:border-gray-800/60 dark:text-white appearance-none ${
