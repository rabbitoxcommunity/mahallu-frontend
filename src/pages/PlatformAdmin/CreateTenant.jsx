...
export default function CreateTenant() {
  ...
  const autoGeneratedSlug = generateSlug(tenantName);

  const onSubmit = async (data) => {
    setLoading(true);
    console.log('=== Submitting Tenant Creation ===');
    console.log('Form data:', data);
    console.log('Auto-generated slug:', autoGeneratedSlug);
    ...
    try {
      const response = await axios.post('/tenants/create', {
        ...
        regNo: data.regNo,
        slug: autoGeneratedSlug, // Use auto-generated slug
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 dark:bg-[#252731] rounded-xl p-6">
              ...
              <div className="space-y-3">
                ...
                {createdCredentials.tenant.nameMalayalam && (
                  <div>
                    <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Mahallu Name (Malayalam)</label>
                    <p className="text-gray-900 dark:text-white">{createdCredentials.tenant.nameMalayalam}</p>
                  </div>
                )}
                {createdCredentials.tenant.address && (
                  <div>
                    <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Address</label>
                    <p className="text-gray-900 dark:text-white">{createdCredentials.tenant.address}</p>
                  </div>
                )}
                {createdCredentials.tenant.addressMalayalam && (
                  <div>
                    <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Address (Malayalam)</label>
                    <p className="text-gray-900 dark:text-white">{createdCredentials.tenant.addressMalayalam}</p>
                  </div>
                )}
                {createdCredentials.tenant.regNo && (
                  <div>
                    <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Registration No.</label>
                    <p className="text-gray-900 dark:text-white">{createdCredentials.tenant.regNo}</p>
                  </div>
                )}
                <div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      readOnly
                      className={`w-full pl-10 pr-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0B65F6] dark:bg-[#252731] dark:border-gray-800/60 dark:text-gray-400 font-mono ${
