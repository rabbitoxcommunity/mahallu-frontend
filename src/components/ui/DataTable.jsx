                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                    ...
                    {createButton && (
                        <Link
                            ...
                            className="flex items-center justify-center gap-2 px-4 py-2.5 text-xs font-medium text-white bg-[#0B65F6] rounded-xl hover:bg-[#0B65F6]/90 transition-colors shadow-sm shadow-[#0B65F6]/20 dark:shadow-none"
                        >
                            <Plus size={16} />
                            {createButton.label}
                        </Link>
                                ...
                                <tr>
                                    <td colSpan={columns.length} className="px-6 py-20 text-center">
                                        <div className="flex flex-col items-center justify-center">
                                            ...
                                            <span className="text-xs font-medium text-gray-500">Loading data...</span>
                                        </div>
                                    </td>
                                </tr>
                            ) : data.length === 0 ? (
                    ...
                    <div className="p-4 md:p-6 border-t border-gray-100 dark:border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <div className="inline-flex rounded-lg shadow-sm overflow-hidden border border-gray-200 dark:border-gray-700">
                            <button
                                ...
                                className="px-3 py-2 border-r border-gray-200 dark:border-gray-700 text-xs font-medium text-gray-500 bg-white dark:bg-[#1e1f25] hover:bg-gray-50 dark:hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                            >
                                <ChevronLeft size={16} />
                            </button>
                            ...
                            <button
                                ...
                                className="px-3 py-2 text-xs font-medium text-gray-500 bg-white dark:bg-[#1e1f25] hover:bg-gray-50 dark:hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                            >
